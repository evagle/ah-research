...
1. **客户为什么从它这里购买并持续复购或续约，而不选其他机构？** 区分首次吸引、相对偏好、习惯和真实切换成本；低切换成本不写成“阻止客户离开”，而要判断公司能否在每次购买或续约时重新赢得客户。
2. **为什么其他资本没有提供更高性价比的商品或服务来抢占市场份额？** 指出约束来自能力、成本、渠道、稀缺资源、监管、组织协同还是复制所需时间，并用具名对手检验；资本已经进入时直接说明，不得把竞争存在改写成进入壁垒。
3. **假设巨头携巨资进入，它能否保住乃至扩张市场份额？** 同时判断现有优势在资金冲击下是否仍成立，以及下一代产品、服务或爆款来自可重复流程还是单次运气。
