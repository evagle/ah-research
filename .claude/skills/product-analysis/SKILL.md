...
对游戏、IP、内容和其他可多归属产品，必须把情感或收藏连续性与排他锁定分开。用户
放弃既有进度、社交关系、虚拟资产或收藏系列可能承担心理成本，但仍可同时消费其他公司的产品；
不得把“更不愿离开”写成“竞争者无法进入”。分析长青机制时，至少检查
核心体验能否重复、社交或账户投入、持续运营和更新节奏、用户反馈回路、新产品管线、
失败筛选及组合分散。判断“系统能力还是运气”必须同时寻找跨产品、跨团队和跨期成功
样本，以及停运、未达预期或新品失败的反例。单一爆款、单次榜首或管理层的长青口号
只能证明一次结果，不能单独证明可重复能力；更准确的结论可以是组合层面的系统能力提高成功概率，
而单款命中仍有显著随机性。
