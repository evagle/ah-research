...
- `.claude/skills/value-profile/references/financial-reading.md` §3 "必读附注" — 关联交易 / 其他应收款 / 应交税费 附注读法, 是 §2.3 关联交易扫描的操作基础
- `.claude/skills/value-profile/references/financial-reading.md` §4 "红旗清单" — 管理层道德红旗的形式化阈值
